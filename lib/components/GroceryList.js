...
import filterIdeas from './helpers/filterIdeas'
  ...
  render() {
    ...
    return (
      ...
      <h1> Welcome {this.state.user.email} </h1>
        <SearchBar searchText= {this.handleSearch.bind(this)}/>
        ...
        <section>
          ...
          <RenderList listItems= {filterIdeas(this.state.listItems, this.state.searchText)} destroy={ this.removeItem.bind(this) } />
        </section>
      </div>
    );
  }
